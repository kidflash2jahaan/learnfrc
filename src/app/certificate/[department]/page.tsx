...
export default async function CertificatePage({
    ...
    return (
      <div className="mx-auto max-w-2xl px-4 pt-28 pb-20 text-center sm:px-6">
        ...
        <p className="mt-2 text-muted-foreground">
          Complete all {total} lessons in <strong>{dept.name}</strong> to unlock
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 pt-24 pb-20 sm:px-6">
      ...
      <div
        id="certificate"
        className="relative overflow-hidden rounded-3xl border bg-card p-8 shadow-[var(--shadow-lg)] sm:p-12"
      ...
      >
        ...
        <div className="relative text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-pretty text-foreground/80">
            has successfully completed all <strong>{total} lessons</strong> of the
          </p>

          <div className="mt-4 inline-flex items-center gap-3 rounded-2xl border border-border px-5 py-3">
            <span
